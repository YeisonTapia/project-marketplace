      ...
      <div v-if="multiple">
        ...
        <div class="images relative-position" v-if="files.length == 0">
          <q-carousel
            ...
            quick-nav
          >
          <q-carousel-slide class="rounded-md image-multiple" img-src="/statics/img/img-default.jpg" /> 
          </q-carousel>
        ...
        <div class="images relative-position" v-else>
          <q-carousel
            ...
            quick-nav
          >
          <q-carousel-slide class="rounded-md image-multiple" v-for="(file,index) in files" 
