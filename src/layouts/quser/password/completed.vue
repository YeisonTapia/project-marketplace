<template>
	<q-page id="pageCompletedPassword" class="flex flex-center bg-fondo">

		<!--Form-->
		<div class="row shadow-3 q-mx-md bg-white" style="width: 350px">
			<div id="form-login-right"
				...
				<div class="text-center q-mt-md">
					<q-btn :loading="loading"
					       color="primary"
					       name="submit"
					       class="btn-change no-border font-family-secondary"
