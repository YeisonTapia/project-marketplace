<template>
	<q-page id="pageChangePassword" class="flex flex-center bg-fondo">
		<!--Form-->
		<div class="row shadow-3 q-mx-md bg-white rounded-sm" style="width: 350px">
			<div id="form-login-right"
			     class="col-12"
			     style="padding: 30px 25px">
				<h4 class="font-family-secondary q-headline text-primary text-center q-mt-none q-mb-md q-pb-sm"
