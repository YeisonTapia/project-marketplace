			...
			<div class="row">
				<div class="col-12">
					<h3 class="title-label-primary text-center">
						<div>Políticas de Privacidad y protección de datos</div>
					</h3>
					<p class="q-pa-xl text-justify">
						{{text}}
					</p>
				</div>
			</div>
...
<script>
  export default {
    ...
    data(){
      return {
        text: this.$store.getters['qsiteSettings/getSettingValueByName']('marketplace::Privacy-protection-policies')
      }
    }
  }
</script>
