      ...
      <div class="col-12 backend-page relative-position">
        <div class="row q-col-gutter-x-sm">
          <div class="col-12 col-md-3">
            <q-list highlight dense class="box">
              <q-item v-for="(module,index) in modules" :key="index"
                      @click.native="getSingleModule(index)" clickable
                      :class="nameModuleSelected == index ? 'router-link-exact-active router-link-active' : ''">
                <q-item-section>
                  {{index}}
                </q-item-section>
                <q-item-section side>
                  <q-chip color="primary" class="text-white" small>
